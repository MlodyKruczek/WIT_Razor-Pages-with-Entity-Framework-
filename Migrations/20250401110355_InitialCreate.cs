        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    LastName = table.Column<string>(name: "Last Name", type: "TEXT", maxLength: 50, nullable: false),
                    FirstName = table.Column<string>(name: "First Name", type: "TEXT", maxLength: 50, nullable: false),
